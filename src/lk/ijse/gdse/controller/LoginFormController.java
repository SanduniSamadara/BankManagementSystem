...
public class LoginFormController {
    ...
    private void checkLogin() throws IOException {
        ...
        if (txtUserName.getText().toString().equals("sanduni") && txtPassword.getText().toString().equals("1234")
                || txtUserName.getText().toString().equals("samadara") && txtPassword.getText().toString().equals("2001")) {
